...
bool UnitTestClass::CC_Bond(const bond &) {
    ...
    cout << "Expected Output: " << "Bond ({Expiration Date}, {Frequency}, {Coupon Rate})" << endl;
    cout << "Code Output: " << copy_bond.ToString() << endl;
...
void UnitTestClass::Defined_Bond(string ED, double f, double cr) {
    ...
    cout << "Expected Output: " << "Bond ({Expiration Date}, {Frequency}, {Coupon Rate})" << endl;
    cout << "Code Output: " << defined_bond.ToString() << endl;
};
...
void UnitTestClass::Bond_PV(double T, double DR, double CR, double f, double FV) {
    ...
    cout << "Testing Bond PV Pricer... " << endl;
    cout << "Expected Output: Present Value of the Bond discounted with respect to the {DR}." <<  endl;
...
void UnitTestClass::weird_T(double T, double DR, double CR, double f, double FV) {
    ...
    bond b;
    // Testing PV Calculations
    cout << "Testing Bond PV Pricer with incorrect inputs... " << endl;
    cout << "Expected Output: ERROR! Expiration Date cannot be < 0!" <<  endl;
    cout << "Bond Price: " << b.Bond_Pricer(T, DR, CR, f, FV) << endl;
}
...
void UnitTestClass::weird_FV(double T, double DR, double CR, double f, double FV) {
    ...
    // Testing PV Calculations
    cout << "Testing Bond PV Pricer with incorrect inputs... " << endl;
    cout << "Expected Output: ERROR! Face Value cannot be < 0!" <<  endl;
    cout << "Bond Price: " << b.Bond_Pricer(T, DR, CR, f, FV) << endl;
}
...
void UnitTestClass::weird_Freq(double T, double DR, double CR, double f, double FV) {
    ...
    // Testing PV Calculations
    cout << "Testing Bond PV Pricer with incorrect inputs... " << endl;
    cout << "Expected Output: ERROR! Frequency cannot be < 0!" <<  endl;
    cout << "Bond Price: " << b.Bond_Pricer(T, DR, CR, f, FV) << endl;
}
